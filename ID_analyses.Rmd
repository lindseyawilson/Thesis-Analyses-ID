...
```{r q3 one-way ANOVAs}
#VEH
res.aovVeh = anova_test(
  data = data_long_foodOnly_factor_veh, dv = kcal, wid = rat,
  within = diet)
get_anova_table(res.aovVeh)

#NAL
res.aovNal = anova_test(
  data = data_long_foodOnly_factor_nal, dv = kcal, wid = rat,
  within = diet)
get_anova_table(res.aovNal)
```
...
##ANOVAs
#HI
res.aovHi = anova_test(
  data = data_long_foodOnly_factor_hi, dv = kcal, wid = rat,
  within = diet)
get_anova_table(res.aovHi)

#LO
res.aovLo = anova_test(
  data = data_long_foodOnly_factor_lo, dv = kcal, wid = rat,
  within = diet)
get_anova_table(res.aovLo)
